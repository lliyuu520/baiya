...
COMMENT ON COLUMN RECORD_QR_CODE_REPLACE.STATUS IS '处理状态：WAITING-等待处理，PROCESSING-处理中，COMPLETED-已完成，FAILED-处理失败';
COMMENT ON COLUMN RECORD_QR_CODE_REPLACE.REMARK IS '备注';
...
CREATE INDEX IDX_RECORD_QR_CODE_REPLACE_STATUS ON RECORD_QR_CODE_REPLACE(STATUS); 