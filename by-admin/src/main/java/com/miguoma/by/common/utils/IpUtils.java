...
public class IpUtils {
    ...
    private static Boolean isMultistage(String ip) {
        return StrUtil.isBlank(ip) || StrUtil.equalsIgnoreCase(ip, "unknown");
    }
    ...
    public static boolean internalIp(final String ip) {
        final byte[] addr = IpUtils.textToNumericFormatV4(ip);
     ...
     * @param addr byte地址
     */
    private static boolean internalIp(final byte[] addr) {
